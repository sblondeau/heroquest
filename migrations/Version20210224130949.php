 ...
 */
final class Version20210224130949 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_768FA90467BAA0E5 ON tile (occupant_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_768FA90467BAA0E5 ON tile');
